    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['file_type'], name='dp_file_type_idx'), models.Index(fields=['file_size'], name='dp_file_size_idx'), models.Index(fields=['download_limit'], name='dp_download_limit_idx'), models.Index(fields=['access_duration'], name='dp_access_duration_idx'), models.Index(fields=['file_type', 'file_size'], name='dp_file_type_size_idx'), models.Index(fields=['download_limit', 'access_duration'], name='dp_download_access_idx')],
                'constraints': [models.CheckConstraint(condition=models.Q(('download_limit__gte', 1)), name='dp_min_download_limit'), models.CheckConstraint(condition=models.Q(('file_size__gte', 0), ('file_size__isnull', True), _connector='OR'), name='dp_non_negative_file_size'), models.CheckConstraint(condition=models.Q(('access_duration__gte', datetime.timedelta(0))), name='dp_non_negative_access_duration')],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sku', models.CharField(help_text='Stock Keeping Unit - unique identifier for inventory management', max_length=100, unique=True, verbose_name='SKU')),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['sku'], name='pp_sku_idx'), models.Index(fields=['barcode'], name='pp_barcode_idx'), models.Index(fields=['manufacturing_date'], name='pp_mfg_date_idx'), models.Index(fields=['manufacturing_location'], name='pp_mfg_location_idx'), models.Index(fields=['batch_number'], name='pp_batch_number_idx'), models.Index(fields=['requires_shipping'], name='pp_requires_shipping_idx'), models.Index(fields=['weight'], name='pp_weight_idx'), models.Index(fields=['fragile'], name='pp_fragile_idx'), models.Index(fields=['hazardous'], name='pp_hazardous_idx'), models.Index(fields=['manufacturing_date', 'manufacturing_location'], name='pp_mfg_date_location_idx'), models.Index(fields=['batch_number', 'manufacturing_date'], name='pp_batch_mfg_date_idx'), models.Index(fields=['manufacturing_cost'], name='pp_mfg_cost_idx')],
                'constraints': [models.CheckConstraint(condition=models.Q(('weight__gte', 0)), name='pp_non_negative_weight'), models.CheckConstraint(condition=models.Q(('manufacturing_cost__gte', 0)), name='pp_non_negative_mfg_cost'), models.CheckConstraint(condition=models.Q(('packaging_cost__gte', 0)), name='pp_non_negative_packaging_cost'), models.CheckConstraint(condition=models.Q(('shipping_to_warehouse_cost__gte', 0)), name='pp_non_negative_ship_cost'), models.CheckConstraint(condition=models.Q(('shelf_life__gt', datetime.timedelta(seconds=0)), ('shelf_life__isnull', True), _connector='OR'), name='pp_positive_shelf_life')],
            },
            bases=('products.product',),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('product_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='products.product')),
                ('duration', models.DurationField(help_text='Expected service duration', verbose_name='Service Duration')),
        ...
        migrations.AddIndex(
            model_name='product',
            index=models.Index(fields=['price', 'category'], name='prod_price_category_idx'),
        ),
        migrations.AddIndex(
            model_name='product',
            index=models.Index(fields=['compare_at_price'], name='prod_compare_price_idx'),
        ),
        migrations.AddIndex(
            model_name='product',
        ...
        migrations.AddIndex(
            model_name='product',
            index=models.Index(fields=['status', 'price', 'category'], name='prod_status_price_category_idx'),
        ),
        migrations.AddIndex(
            model_name='product',
        ...
        migrations.AddConstraint(
            model_name='product',
            constraint=models.CheckConstraint(condition=models.Q(('cost_price__gt', 0)), name='non_negative_greater_than_zero_cost_price'),
        ),
        migrations.AddConstraint(
            model_name='product',
            constraint=models.CheckConstraint(condition=models.Q(('compare_at_price__gt', 0)), name='non_negative_greater_than_zero_compare_at_price'),
        ),
        migrations.AddConstraint(
            model_name='product',
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['service_type'], name='sp_service_type_idx'),
        ),
        migrations.AddIndex(
            model_name='serviceproduct',
            index=models.Index(fields=['duration'], name='sp_duration_idx'),
        ),
        migrations.AddIndex(
            model_name='serviceproduct',
            index=models.Index(fields=['location_required'], name='sp_location_required_idx'),
        ),
        migrations.AddIndex(
            model_name='serviceproduct',
            index=models.Index(fields=['service_type', 'duration'], name='sp_service_type_duration_idx'),
        ),
        migrations.AddIndex(
            model_name='serviceproduct',
            index=models.Index(fields=['service_type', 'location_required'], name='sp_service_type_loc_idx'),
        ),
        migrations.AddIndex(
            model_name='serviceproduct',
            index=models.Index(fields=['duration', 'location_required'], name='sp_duration_loc_idx'),
        ),
        migrations.AddConstraint(
            model_name='serviceproduct',
            constraint=models.CheckConstraint(condition=models.Q(('duration__gte', datetime.timedelta(seconds=300))), name='sp_min_duration_5m'),
        ),
        migrations.AddConstraint(
            model_name='serviceproduct',
            constraint=models.CheckConstraint(condition=models.Q(('location_required', False), ('location__isnull', False), _connector='OR'), name='sp_location_required_with_location'),
        ),
    ]
