    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, help_text='Parent category for nested subcategories', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='children', to='category.category', verbose_name='Parent Category')),
            ],
            options={
                ...
                'constraints': [models.UniqueConstraint(condition=models.Q(('is_deleted', False)), fields=('parent', 'name'), name='unique_category_name'), models.CheckConstraint(condition=models.Q(('pk', models.F('parent_id')), _negated=True), name='prevent_self_parent_reference_for_category')],
            },
        ),
    ]
